...
public:
    ...
    CAmount GetMinNotDustSize(const CFeeRate& minRelayTxFee) const
    {
        ...
        // i.e. total is 148 + 32 = 182 bytes. Default -minrelaytxfee is 10000 ubtcu per kB
        // and that means that fee per txout is 182 * 10000 / 1000 = 1820 ubtcu.
        // So dust is a txout less than 1820 *3 = 5460 ubtcu
