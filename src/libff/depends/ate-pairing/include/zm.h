...
struct addsubmul : E {
    ...
    {
        T::sub(static_cast<T&>(*this), static_cast<T&>(*this), rhs);
        return static_cast<T&>(*this);
    }
    MIE_FORCE_INLINE T& operator*=(const T& rhs)
    {
        T::mul(static_cast<T&>(*this), static_cast<T&>(*this), rhs);
        return static_cast<T&>(*this);
    }
...
struct dividable : E {
    ...
    {
        T rdummy;
        T::div(static_cast<T*>(this), rdummy, static_cast<const T&>(*this), rhs);
        return static_cast<T&>(*this);
    }
    MIE_FORCE_INLINE T& operator%=(const T& rhs)
    {
        T::div(0, static_cast<T&>(*this), static_cast<const T&>(*this), rhs);
        return static_cast<T&>(*this);
    }
...
struct hasNegative : E {
    ...
    {
        T c;
        T::neg(c, static_cast<const T&>(*this));
        return c;
    }
};
...
struct shiftable : E {
    ...
    {
        T out;
        T::shl(out, static_cast<const T&>(*this), n);
        return out;
    }
    MIE_FORCE_INLINE T operator>>(size_t n) const
    {
        T out;
        T::shr(out, static_cast<const T&>(*this), n);
        return out;
    }
    ...
    {
        T::shl(static_cast<T&>(*this), static_cast<const T&>(*this), n);
        return static_cast<T&>(*this);
    }
    MIE_FORCE_INLINE T& operator>>=(size_t n)
    {
        T::shr(static_cast<T&>(*this), static_cast<const T&>(*this), n);
        return static_cast<T&>(*this);
    }
};
